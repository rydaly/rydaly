...
function parallax()
{
  if( $( "#parallax-window" ).length > 0 ) 
  {
    ...
    // console.log( plxWindowTopToWindowTop );
...
function logo01() {
  ...
  // init visibility
  // tl.set( hello, { autoAlpha:0 } );
  // tl.set( more, { autoAlpha:0 } );
  ...
  //
  // tl.to( hello, 2, { autoAlpha:1 }, 0.25 );
  // tl.to( more, 2, { autoAlpha:1 }, 2 );
  //
...
function addFadeIn( scrollobj, fadeselector ) {
  // console.log( $(scrollobj).find(fadeselector) );
